...
<div class="container mx-auto mt-8 px-4">
    <div class="mb-8 text-center">
        <h1 class="text-3xl font-semibold text-gray-800">Editar Gênero</h1>
        <hr class="my-4 border-t-2 border-gray-300 w-1/4 mx-auto">
    </div>

    <form action="{{ route('generos-update', ['id' => $generos->id]) }}" method="POST" class="bg-white shadow-md rounded-lg p-6">
        @csrf
        @method('PUT')
        ...
        <div class="mb-6">
            ...
            <input 
                ...
                value="{{ old('nome_genero', $generos->nome_genero) }}" 
                required
            >
            @error('nome_genero')
